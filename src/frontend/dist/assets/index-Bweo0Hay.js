...
function About() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", ref, className: "py-24 md:py-32 bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal font-body text-primary text-sm tracking-[0.3em] uppercase mb-4", children: "About Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "reveal font-display font-bold text-4xl md:text-5xl text-foreground mb-6 accent-underline pb-4", children: [
        "Passionate About",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "Visual Storytelling"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal w-16 h-0.5 bg-primary mb-8" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal font-body text-muted-foreground text-base md:text-lg leading-relaxed mb-6", children: "I'm Seenu Arjunan, a multidisciplinary Graphic Designer with over 6 years of professional experience across print, digital, and interactive media. My work spans editorial design, brand identity, web UI, and character animation — each project driven by a deep belief that great design communicates and inspires." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal font-body text-muted-foreground text-base leading-relaxed mb-8", children: "Specializing in illustration, poster design, newspaper page layout, and character rigging, I bring a meticulous craft and creative energy to every brief. My goal is to push boundaries of visual communication while delivering polished, production-ready work." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal grid grid-cols-3 gap-6", children: [
        { value: "6+", label: "Years Experience" },
        { value: "4", label: "Companies" },
        { value: "∞", label: "Passion for Design" }
      ].map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-3xl text-primary mb-1", children: stat.value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-xs text-muted-foreground uppercase tracking-wider", children: stat.label })
      ] }, stat.label)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 -left-4 w-full h-full border-2 border-primary/30 rounded-sm" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-72 h-80 md:w-80 md:h-96 bg-muted rounded-sm overflow-hidden shadow-card-dark", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-6xl text-primary mb-2", children: "SA" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-0.5 bg-primary mx-auto mb-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-muted-foreground text-sm tracking-widest uppercase", children: "Graphic Designer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex flex-wrap gap-2 justify-center", children: ["Illustrator", "InDesign", "Figma", "Photoshop"].map(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-20 h-20 border-r-2 border-t-2 border-primary/40 rounded-tr-sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 w-20 h-20 border-l-2 border-b-2 border-primary/40 rounded-bl-sm" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-3 -right-3 w-6 h-6 bg-primary rounded-full shadow-gold-glow" })
    ] }) })
  ] }) }) });
}
const contactInfo = [
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", ref, className: "bg-card border-t border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-24 md:py-32 max-w-7xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal font-body text-primary text-sm tracking-[0.3em] uppercase mb-4", children: "Let's Talk" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "reveal font-display font-bold text-4xl md:text-5xl text-foreground mb-4", children: "Get In Touch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal w-16 h-0.5 bg-primary mx-auto mb-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal font-body text-muted-foreground max-w-md mx-auto text-base leading-relaxed", children: "Open to new opportunities, collaborations, and creative projects. Let's build something remarkable together." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto mb-16", children: contactInfo.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: item.href,
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-primary/10 border border-primary/30 rounded-sm flex items-center justify-center text-primary mb-4 group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300", children: item.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground uppercase tracking-widest mb-2", children: item.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-medium text-foreground text-sm group-hover:text-primary transition-colors duration-200 break-all", children: item.value })
          ]
        },
        item.label
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal flex justify-center mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 border border-primary/30 bg-primary/5 px-6 py-3 rounded-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-green-400 animate-pulse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-muted-foreground", children: "Available for freelance and full-time opportunities" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal text-center mb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: "https://www.behance.net/ashok_arjunan1",
          target: "_blank",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-display font-bold text-lg tracking-wider text-foreground", children: [
        "SEENU ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "ARJUNAN" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-muted-foreground text-sm text-center", children: [
        "© ",
        year,
        " Seenu Arjunan. All rights reserved."
      ] }),
...
function Education() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "education", ref, className: "py-24 md:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal font-body text-primary text-sm tracking-[0.3em] uppercase mb-4", children: "Background" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "reveal font-display font-bold text-4xl md:text-5xl text-foreground mb-4", children: "Education" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal w-16 h-0.5 bg-primary mx-auto" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto", children: educationData.map((edu, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        "data-ocid": `education-card-${index2}`,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-primary border border-primary/40 px-3 py-1 rounded-sm tracking-wider", children: edu.period }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: edu.icon })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-primary uppercase tracking-widest", children: edu.qualification }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground mb-2", children: edu.degree }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-sm font-medium mb-6", children: edu.institution }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-0.5 bg-border mb-6" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: edu.highlights.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 right-4 w-12 h-12 border-r border-b border-primary/20 rounded-br-sm pointer-events-none" })
        ]
      },
      edu.institution
    )) })
...
function Experience() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "experience", ref, className: "py-24 md:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal font-body text-primary text-sm tracking-[0.3em] uppercase mb-4", children: "Career" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "reveal font-display font-bold text-4xl md:text-5xl text-foreground mb-4", children: "Work Experience" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal w-16 h-0.5 bg-primary mx-auto" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-12", children: experiences.map((exp, index2) => {
        const isLeft = index2 % 2 === 0;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": `experience-item-${index2}`,
            className: `reveal relative flex flex-col md:flex-row gap-8 ${isLeft ? "md:flex-row" : "md:flex-row-reverse"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `flex-1 ml-10 md:ml-0 ${isLeft ? "md:pr-12" : "md:pl-12"}`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-sm p-6 shadow-card-dark hover:border-primary/30 hover:shadow-gold-glow transition-all duration-300", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 mb-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-primary border border-primary/40 px-3 py-1 rounded-sm tracking-wider", children: exp.period }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: exp.location })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground mb-1", children: exp.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-primary font-medium text-sm mb-4", children: exp.company }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: exp.responsibilities.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "li",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary mt-1 shrink-0", children: "•" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-4 md:left-1/2 top-6 -translate-x-1/2 z-10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 rounded-full bg-primary shadow-gold-glow border-2 border-background" }) }),
    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none", "aria-hidden": "true", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-20 left-10 w-32 h-32 border border-primary/15 rotate-12 rounded-sm" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-0 w-1 h-64 bg-gradient-to-b from-transparent via-primary/30 to-transparent" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-primary to-transparent opacity-60" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-0 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col-reverse lg:flex-row items-end lg:items-stretch gap-8 lg:gap-0 min-h-[calc(100vh-6rem)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col justify-center pb-16 order-2 lg:order-1 lg:pr-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-5xl md:text-7xl lg:text-8xl leading-tight text-foreground mb-4 animate-fade-in-up", children: [
            "Seenu",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Arjunan." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 md:h-16 flex items-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `font-display font-semibold text-2xl md:text-4xl text-muted-foreground transition-all duration-400 ${visible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2"}`,
              style: { transition: "opacity 0.4s, transform 0.4s" },
              "aria-live": "polite",
              children: roles[currentRole]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-base md:text-lg max-w-xl leading-relaxed mb-10 animate-fade-in", children: "Crafting compelling visual experiences with 6+ years of expertise in illustration, poster design, newspaper layout, and character animation." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4", "data-ocid": "hero-ctas", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-14 flex items-center gap-3 text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-0.5 bg-border" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs tracking-widest uppercase", children: "Scroll to explore" })
          ] })
        ] }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      "data-ocid": "navbar",
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-card/95 backdrop-blur-md border-b border-border shadow-card-dark" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-4 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-8", children: navLinks.map((link) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `font-body text-sm font-medium tracking-wider uppercase transition-colors duration-200 relative group ${isActive ? "text-primary" : "text-muted-foreground hover:text-foreground"}`,
                children: [
                  link.label,
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card/98 backdrop-blur-md border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col px-6 py-4 gap-4", children: navLinks.map((link) => {
...
function Skills() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", ref, className: "py-24 md:py-32 bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal font-body text-primary text-sm tracking-[0.3em] uppercase mb-4", children: "Expertise" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "reveal font-display font-bold text-4xl md:text-5xl text-foreground mb-4", children: "Skills Showcase" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal w-16 h-0.5 bg-primary mx-auto mb-6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal font-body text-muted-foreground max-w-xl mx-auto text-base", children: "A versatile toolkit spanning print, digital, motion, and interactive design disciplines." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 bg-primary/10 border border-primary/30 rounded-sm flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:border-primary transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-base text-primary group-hover:text-primary-foreground transition-colors duration-300", children: skill.icon }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-foreground text-base mb-1 truncate", children: skill.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground text-xs uppercase tracking-wider", children: skill.category })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "Proficiency" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-sm text-primary", children: [
                    skill.level,
                    "%"
                  ] })
                ] }),
